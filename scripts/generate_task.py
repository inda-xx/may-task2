...
def main(api_key):
    ...
    prompt = (f"Create a new programming task based on this template: {template}. "
              ...
              "Also, provide a set of tests for the task and a suggested solution. The tests must be thorough as they will be used to evaluate the students' solutions. It is therefore extremely important that the tests are correct and cover all edge cases. Additionally, provide the name of the test class and the test methods in the task description for the students. "
