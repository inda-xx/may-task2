...
def main(api_key):
    ...
    prompt = (f"Create a new programming task based on this template: {template}. "
              ...
              "Use the following existing code and tests as inspiration. Also use the structure of the original task description based on the .md file to ensure that the new generated tasks look aesthetically pleasing and provide detailed instructions for the students. "
              "The new task should include specific function names where necessary. "
              "Also, provide a set of tests for the task and a suggested solution. The tests must be thorough, robust, and detailed as they will be used to evaluate the students' solutions. It is extremely important that the tests are correct and cover all edge cases, including invalid inputs, boundary conditions, and performance considerations. "
              "Additionally, provide the name of the test class and the test methods in the task description for the students. "
              "The code template must be compatible with the tests, including the correct function names and return types, to ensure that the tests pass. "
