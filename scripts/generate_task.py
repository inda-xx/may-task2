...
def main(api_key):
    ...
    prompt = (f"Create a new programming task based on this template: {template}. "
              ...
              "Use the following existing code and tests as inspiration. Also use the structure of the original task description based on the .md fild to make sure that the new generated tasks look aesthetically pleasing. The new task should include specific function names where necessary."
