this assignment, you will be constructing a basic game using the Java programming language. You will need to create two classes: `Player` and `Enemy`. The game includes the following functionalities: player movement, scoring system, and enemy interactions.
